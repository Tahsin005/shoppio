...
const colorChipClass = "group inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-2 text-sm text-foreground transition hover:bg-muted";
const colorDotClass = "h-4 w-4 rounded-full border border-black/10";
const removeIconClass = "h-3.5 w-3.5 text-muted-foreground group-hover:text-foreground";
