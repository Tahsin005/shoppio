...
const uploadLabelClass = "flex min-h-28 cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/40 px-4 py-6 text-center transition hover:bg-muted";
...
const imageCardClass = "overflow-hidden rounded-xl border border-border bg-card";
