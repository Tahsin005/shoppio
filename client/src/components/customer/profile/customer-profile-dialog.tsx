...
const defaultClass = "inline-flex rounded-full border border-primary/30 bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary";
...
const checkboxRowClass = "flex items-center gap-3 border border-border bg-secondary/40 px-3 py-3 text-sm text-foreground";
