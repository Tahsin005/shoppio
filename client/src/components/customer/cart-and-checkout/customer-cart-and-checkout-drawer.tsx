...
const contentClass = "ml-auto flex h-[90dvh] max-h-[90dvh] w-full overflow-hidden rounded-none border-l border-border bg-background p-0";
const shellClass = "grid h-full min-h-0 w-full lg:grid-cols-[1.7fr_1fr]";
const leftPaneClass = "min-h-0 border-b border-border lg:border-b-0 lg:border-r";
const rightPaneClass = "min-h-0 bg-gradient-to-b from-secondary/40 via-background to-background";
const rightInnerClass = "flex h-full min-h-0 flex-col p-5";
const panelClass = "flex h-full min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm";
...
const totalRowClass = "flex items-center justify-between border-t border-border pt-4 text-base font-semibold";
...
const promoTitle = "flex items-center gap-2 text-sm font-medium text-foreground";
const infoBoxClass = "rounded-2xl border border-dashed border-border bg-background/70 p-4 text-sm text-muted-foreground";
