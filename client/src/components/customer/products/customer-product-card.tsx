...
const cardClass = "overflow-hidden border-border/60 bg-card/80 transition hover:border-primary/50";
const linkClass = "block";
const imageWrapClass = "relative aspect-[4/5] bg-muted";
const imageClass = "h-full w-full object-cover transition duration-300 hover:scale-[1.02]";
const noImageClass = "flex h-full items-center justify-center text-sm text-muted-foreground";
const saleBadgeClass = "absolute left-3 top-3 border-primary/30 bg-secondary text-primary hover:bg-secondary";
