...
const categoryBadgeClass = "border-border bg-secondary text-secondary-foreground hover:bg-secondary";
const stockBadgeClass = "border-primary/30 bg-primary/15 text-primary hover:bg-primary/15";
