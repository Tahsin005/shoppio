...
const baseButtonClass = "inline-flex items-center justify-center gap-2 border px-4 py-2 text-sm font-medium transition";
const activeButtonClass = "border-primary bg-primary/15 text-primary ring-2 ring-primary/20";
const inactiveButtonClass = "border-border bg-secondary text-secondary-foreground hover:border-primary/40";
