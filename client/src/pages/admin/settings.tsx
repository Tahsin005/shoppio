...
const uploadBoxClass = "flex min-h-[220px] flex-col items-center justify-center gap-4 border border-dashed border-border bg-background/40 p-6 text-center";
const uploadIconWrapClass = "flex h-14 w-14 items-center justify-center border border-border bg-secondary/50";
...
const emptyStateClass = "border border-border bg-background/40 p-6 text-sm text-muted-foreground";
