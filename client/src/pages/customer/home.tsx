...
const sectionTitleClass = "text-3xl font-medium tracking-tight text-foreground sm:text-4xl lg:text-5xl";
const bannerGridClass = "grid gap-6 lg:grid-cols-[1.6fr_1fr]";
const bannerMainCardClass = "group relative overflow-hidden border border-border/30 bg-card shadow-xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5";
const bannerMainImageClass = "h-[540px] w-full object-cover transition-all duration-700 group-hover:scale-105";
const bannerSideGridClass = "grid gap-6 sm:grid-cols-2 lg:grid-cols-1";
const bannerSideCardClass = "group overflow-hidden border border-border/40 bg-card shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5";
const bannerSideImageClass = "h-[258px] w-full object-cover transition-all duration-700 group-hover:scale-105";
const categoryGridClass = "grid gap-6 sm:grid-cols-2 xl:grid-cols-4";
const categoryCardClass = "group relative overflow-hidden border border-border/40 bg-card p-1.5 transition-all duration-500 hover:-translate-y-1 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5";
const categoryContentClass = "h-full space-y-5 bg-gradient-to-br from-background/50 to-muted/30 p-8 backdrop-blur-sm transition-colors duration-500 group-hover:bg-background/80";
const categoryIconWrapClass = "flex h-14 w-14 items-center justify-center bg-primary/5 text-primary ring-1 ring-primary/10 transition-transform duration-500 group-hover:scale-110 group-hover:bg-primary/10";
...
const categoryLinkClass = "inline-flex items-center gap-2 text-sm font-semibold text-primary transition-colors group-hover:text-primary/80";
...
const couponCardClass = "group relative overflow-hidden border border-dashed border-primary/20 bg-primary/[0.02] transition-all duration-300 hover:border-primary/40 hover:bg-primary/[0.04]";
const couponContentClass = "space-y-6 p-8";
const couponIconWrapClass = "flex h-12 w-12 items-center justify-center bg-primary/10 text-primary transition-transform duration-500 group-hover:rotate-12";
const couponIconClass = "h-6 w-6";
const couponCodeClass = "text-2xl font-bold tracking-widest text-primary";
const couponBadgeClass = "border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary hover:bg-primary/20";
...
const productCardClass = "group flex h-full flex-col overflow-hidden border border-border/40 bg-card p-2 transition-all duration-500 hover:-translate-y-1 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5";
const productContentClass = "flex flex-1 flex-col justify-between space-y-5 p-4";
const productImageWrapClass = "relative aspect-[4/5] w-full overflow-hidden bg-muted/30";
const productImageClass = "h-full w-full object-cover transition-all duration-700 group-hover:scale-105";
const productInfoWrapClass = "space-y-3";
const productBrandRowClass = "flex items-center justify-between gap-3";
const productBrandClass = "text-xs font-semibold uppercase tracking-wider text-muted-foreground";
const productTitleClass = "line-clamp-2 text-base font-medium leading-relaxed text-foreground transition-colors group-hover:text-primary";
const productPriceRowClass = "flex items-end justify-between gap-3 pt-2";
const productPriceClass = "text-xl font-semibold tracking-tight text-foreground";
const productOriginalPriceClass = "text-sm font-medium text-muted-foreground line-through decoration-muted-foreground/50";
const productViewClass = "inline-flex h-8 items-center justify-center bg-primary/5 px-4 text-xs font-semibold text-primary opacity-0 transition-all duration-300 group-hover:bg-primary/10 group-hover:opacity-100";
                    ...
                    {!!data.categories.length ? (
                        <section>
                            ...
                            <div className={categoryGridClass}>
                                {data.categories.slice(0, 4).map((categoryItem, index) => (
                                    <Link key={index} to={`/collections?category=${categoryItem._id}`}>
                    ...
                    {!!data.coupons.length ? (
                        <section>
                            ...
                            <div className={couponGridClass}>
                                {data.coupons.slice(0, 4).map((coupon, index) => (
                                    <Card key={index} className={couponCardClass}>
