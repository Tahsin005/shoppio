...
export const getCheckoutWithPoints = asyncHandler(async (req: Request, res: Response) => {
...
export const createCheckoutWithPoints = asyncHandler(async (req: Request, res: Response) => {
    const dbUser = await getDbUserFromReq(req);
